...
var isExpression = function (got) {
    return (0, exports.isFunctionCall)(got) || (0, exports.isPropertyType)(got);
};
...
var isComparisonFilter = function (got) {
    ...
    return Array.isArray(got) &&
        ...
        ((0, exports.isGeoStylerBooleanFunction)(got[1]) || (0, isString_1.default)(got[1])) &&
        (0, exports.isPropertyType)(got[2]) &&
...
var isGeoStylerNumberFunction = function (got) {
    return [
        ...
        'toDegrees',
        'toRadians'
    ].includes(got === null || got === void 0 ? void 0 : got.name);
};
